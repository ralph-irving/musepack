...
/*
 *  For every architectures you want to profile/checkpoint you need the following items:
 *
 *  uintmax_t:
 *      A type which is used for time calculating, mostly 32 bit or 64 bit,
...
report ( void )
{
    ...
    // Auslesen der CPU-Taktfrequenz, falls proc-FS vorhanden
